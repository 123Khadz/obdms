               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="home"><img src="images/logo.png" height="40%" width="40%" alt="#" /></a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 ">
                     <div class="text-bg">
                        <h1>Red Gold</h1>
                        <span>Blood Donation Manager</span><br> 
                        <span><strong class="land_bold">Looking For Blood?</strong></span>
                        <a href="contact">Contact Us</a>
                     </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                     <div class="text-img">
                        <figure><img src="images/blood4.png" height="70%" width="70%" /></figure>
                     </div>
                  </div>
               </div>
            </div>
							...
							<div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
								<div class="best_text">
									<p>
										...
										banks easier. <br><strong>Be a Donor! Be a Life Saver!</strong>
									</p>
	...
	<footer>
		<div class="footer">
			...
			<div class="copyright">
				<div class="container">
					<p>
						<strong>&copy; 2022 All Rights Reserved. <a href="home">Red Gold (Blood Donation Management System)</a></strong>
					</p>
				</div>
			</div>
		</div>
